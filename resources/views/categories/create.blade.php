...
<div class="max-w-md mx-auto bg-white dark:bg-gray-800 p-6 rounded shadow text-gray-900 dark:text-white">
    <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-semibold">Pridėti naują kategoriją</h2>
    ...
    <form action="{{ route('categories.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <select name="type"
                ...
                <option value="income" @selected(old('type') === 'income')>Pajamos</option>
                <option value="expense" @selected(old('type') === 'expense')>Išlaidos</option>
            </select>
        </div>
