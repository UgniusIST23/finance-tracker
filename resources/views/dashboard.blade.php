...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg p-5 shadow text-gray-900 dark:text-white">
                ...
                <ul class="list-disc list-inside space-y-1 text-gray-700 dark:text-gray-300">
                    ...
                    <li>Redaguoti ar šalinti – šalia kiekvienos kategorijos</li>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg p-5 shadow text-gray-900 dark:text-white">
                ...
                <ul class="list-disc list-inside space-y-1 text-gray-700 dark:text-gray-300">
                    ...
                    <li>Analizuokite naujausią transakciją.</li>
